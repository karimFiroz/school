<div align="center">
	<form action="form_all_students.php" method="GET">
	<fieldset>
	<legend></legend>
To see all student input ID<input type="text" name="id">
...
$y=$_GET['id'];
$result = mysql_query("SELECT * FROM sfdata where id='$y'"); 
?>

<?php
	$id=$_GET['id'];
$conn=mysqli_connect('localhost','root','','firozshah');//ok
		$sql="SELECT * FROM sfdata where id=$id;";//ok
...
<body style="background:#E1E0E8;color:#000;">
   ...
   <h2 align="center"><strong>Firozshah City Corporation Girls' High School</strong></h2><br />
		...
		<table class="table" align="center"border="0">
					...
					<th width="100" class="text-left">Class:</th>
					...
					<td class="text-left"><?php echo $std['sclass']; ?></td>
					<td class="text-left"> <?php echo $std['roll']; ?></td>
					<td class="text-left"><?php echo $std['snEn']; ?></td>
					<td class="text-left"><?php echo $std['fnEn']; ?></td>
					<td class="text-left"> <?php echo $std['mnEn']; ?></td>
					
					<td class="text-left"> <?php echo $std['section']; ?></td>
					<td class="text-left"> <?php echo $std['fmob']; ?></td>
					</tr>
